...
Cobblemon Nuzlocke & Soul Link ships under **one license shared by every mod shiero publishes**. Routes, Nuzlocke & Soul
...
```mermaid
flowchart TD
    Q{How are you using<br/>Cobblemon Nuzlocke & Soul Link?} --> P[🎮 Personal / non-commercial]
    Q --> R[📦 A FREE modpack]
...
!!! note "It depends on Routes"
    This mod requires [Routes](../routes/index.md) to run. Both carry the same license, so honouring
    one means honouring the other.
...
([Modrinth](https://modrinth.com/project/cobblemon-nuzlocke-soullink), CurseForge or this wiki) in your description. Ask in the Discord if you want branding art for thumbnails — go
make it look good. 💛
