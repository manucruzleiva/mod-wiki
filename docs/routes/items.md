...
Use it and you're whisked to the **nearest known town** on the route network — and because every
**activated waystone registers as a town**, it works whether or not you run the Waystones mod.
